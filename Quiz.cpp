...
void rules()
{
    ...
    cout << "How you answer: You answer the questions\n";
    cout << "                using either the numbers\n";
    cout << "                beside the answer or just\n";
    cout << "                type the answer into the box\n\n";
...
void question1()
{
    ...
    cout << "Which of these was the first superset of 'C'?\n\n";
    cout << "1. 'C++' \n";
    cout << "2. 'C#' \n";
    cout << "3. 'C-ext' \n";
    cout << "4. 'Rust' \n\n";
    ...
    if (lowerChoice == "c#" || lowerChoice == "c-ext" || lowerChoice == "rust" || lowerChoice == "2" || lowerChoice == "3" || lowerChoice == "4") {
        Q1 = false;
        Q2 = true;
        system("cls");
        cout << "    !The {code} Quiz!       \n";
...
int main() 
{
    ...
    do
    {
        ...
        if (string c = SoR; c == "start" || c == "Start" || c == "START")
        {
            system("cls");
            cout << "    !The {code} Quiz!       \n";
            cout << "-------------------------\n\n\n";
        ...
        else if (c == "rules" || c == "Rules" || c == "RULES")
        {
            system("cls");
            cout << "    !The {code} Quiz!       \n";
            cout << "-------------------------\n\n\n";
